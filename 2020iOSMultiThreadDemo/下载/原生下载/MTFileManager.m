...
{
    return [[MTFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MTFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MTFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MTFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MTFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MTFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
